...
import (
	...
	"category-service/internal/pkg/interceptor"
	"category-service/internal/pkg/util/loader"

	internal_domain_core_category_controller_http_grpc_handler "category-service/internal/domain/core/category/controller/http/grpc/handler"
...
func main() {
	certificate, err := loader.LoadCert("/certs/category-service.crt", "/certs/category-service.key")
	if err != nil {
	...
	categoryHandler := internal_domain_core_category_controller_http_grpc_handler.InitCategoryHandler()
	pb_category.RegisterCategoryHandlerServer(server, categoryHandler)
